...
<font size="22" face="rockwell" color="maroon">WELCOME ADMINISTRATOR!!</font>
<tr>
<br>
<p><font size="15" face="comic" color="cyan"><a href="adminadd.jsp">ADD/REMOVE Books</a></font></p></br>
<%
...
<tr><td>User Name:<INPUT TYPE=TEXT NAME="user" value="<%=user%>" input disabled="disabled" ></td>
...
<tr><td>Contact Number: <INPUT TYPE=TEXT NAME="contactno" value="<%=contactno%>" input disabled="disabled" ></td>
...
<tr>
<FORM ACTION="editinfo2.jsp" METHOD="POST">
<br><td><INPUT TYPE=Submit VALUE="Edit"></td></br>

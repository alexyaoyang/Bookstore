...
%>
	<p></p>You have cancelled <%=minus%> rent(s). The balance of books in the order is <%=hbalance%>.</p><%
		...
		stmt1.executeUpdate("UPDATE book SET no_of_books = '"+balance+"',Cancel='"+minus+"',Rent='"+Sales+"' WHERE book_id = " + id);
		}
		if(hbalance<0)
		{
...
%>
 <INPUT TYPE="submit" value="Back to Rent Removal" onClick="parent.location='viewrents.jsp'">

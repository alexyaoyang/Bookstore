...
try{
status=statement.executeUpdate("UPDATE customer set Password='"+pass1+"', customer_name='"+fname +"', customer_last_name='"+lname+"', customer_contact='"+contactno+"', customer_email='"+eadd+"', customer_address='"+add+"', birthmonth='"+birthm+"', birthday='"+birthd+"', birthyear='"+birthy+"', Answer='"+answ+"' where user_name ='"+uname+"'");
}
